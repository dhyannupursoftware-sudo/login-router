...
export default function Todo() {
  ...
  const submitHandler = () => {
    if (!task.trim()) return;
    if (editIndex !== null) {
      dispatch({ type: "EDIT_TODO", payload: { index: editIndex, text: task } });
      setEditIndex(null);
    } else {
          ...
          <li key={index} className="todo-item">
            ...
            <div className="btn-group">
              <button
                ...
                disabled={!item.done} // disable if checkbox not checked
              >
                Edit
              </button>
              ...
              <button
                ...
                onClick={() =>
                  item.done ? dispatch({ type: "DELETE_TODO", payload: index }) : null
                }
                disabled={!item.done} // disable if checkbox not checked
              >
                Delete
